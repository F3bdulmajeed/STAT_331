...
the variance of the systematic mean,$ Var\left({\bar{y}}_{sys}\right)$.
\
**Solution**
...
\
9. The relative efficiency of the variance of the simple random mean, $Var(\bar{y})$, and  the variance of the systematic mean, $Var\left({\bar{y}}_{sys}\right) =  210.4263$ which it shows that the systematic sampling estimator ${\bar{y}}_{sys}$ for the given population, is $21.0426$  times more efficient than the one based on SRS
\
